...
: Nitrate fluxes observed in the Arctic Ocean. \* Turbulent vertical nitrate flux given in mmol N m⁻² d⁻¹. \*\* Under ice cover. \*\*\* Open water. AABC: Anticyclonic Arctic Boundary Current. Perennial: Measured below the extent of seasonal nitrate variation. See {~~Supplementary Material~>[the data file](data/fn-compilation.csv)~~} for complete data set. {#tbl:nitrate_fluxes}
